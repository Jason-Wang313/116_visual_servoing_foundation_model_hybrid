...
This repository contains a hardened, honest workshop-only robotics paper draft for `visual_servoing_foundation_model_hybrid`.
...
Canonical local PDF path: `C:/Users/wangz/Downloads/116.pdf`
